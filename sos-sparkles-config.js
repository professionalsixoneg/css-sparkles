...
var Sparkle = function() {
	 ...
	 * initialize
	 */
	var init = function(wrapperId, _totalStars, _animationSpeed) {
        settings.totalStars = _totalStars;
        settings.animationSpeed = _animationSpeed;
		initSlots(wrapperId);
		buildStars();
	...
	var animateStar = function(star) {
		var speed = settings.animationSpeed + Math.random() * settings.animationSpeed;
